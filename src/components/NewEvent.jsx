...
export const NewEvent = ({ createEvent }) => {
  ...
  //     const a = await fetch("http://localhost:3000/categories");
  //     const cat = await a.json();

  //     const b = await fetch("http://localhost:3000/users");
  //     const use = await b.json();
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          <form onSubmit={handleSubmit}>
            ...
            <ModalFooter>
              <Button type="submit" colorScheme="pink" onClick={createEvent}>
                Submit
              </Button>
